...
def main(cfg: DictConfig) -> None:
    ...
    stimuli = pysaliency.FileStimuli.read_hdf5("pysaliency_datasets/MIT1003/stimuli.hdf5")
    all_fixations = pysaliency.FixationTrains.read_hdf5("pysaliency_datasets/MIT1003/fixations.hdf5")

    stimuli, all_fixations = pysaliency.filter_datasets.filter_stimuli_by_size(
        stimuli,
        all_fixations,
        size=(768, 1024),
    )
