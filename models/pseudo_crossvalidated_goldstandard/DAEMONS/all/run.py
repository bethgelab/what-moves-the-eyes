...
stimuli_train = pysaliency.read_hdf5('pysaliency_datasets/DAEMONS/stimuli_train.hdf5')
stimuli_train.cached = False

stimuli_validation = pysaliency.read_hdf5('pysaliency_datasets/DAEMONS/stimuli_validation.hdf5')
